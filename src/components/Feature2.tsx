...
const VideoCard: React.FC<VideoCardProps> = ({
    ...
    return (
        <div className="video-card group relative aspect-[16/9] w-full overflow-hidden rounded-lg bg-gray-300 cursor-pointer opacity-0 translate-y-12">
            <img
                src={imageUrl}
            ...
            {hasPlayButton && (
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-16 h-16 bg-white bg-opacity-90 rounded-full flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
